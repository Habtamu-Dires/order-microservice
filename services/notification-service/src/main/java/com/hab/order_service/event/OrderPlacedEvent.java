 ...
 */
package com.hab.order_service.event;
...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3549029696424290600L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.hab.order_service.event\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"firstname\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"lastname\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static com.hab.order_service.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.hab.order_service.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.hab.order_service.event.OrderPlacedEvent.Builder newBuilder(com.hab.order_service.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.hab.order_service.event.OrderPlacedEvent.Builder();
    } else {
      return new com.hab.order_service.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.hab.order_service.event.OrderPlacedEvent.Builder newBuilder(com.hab.order_service.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.hab.order_service.event.OrderPlacedEvent.Builder();
    } else {
      return new com.hab.order_service.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.hab.order_service.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.hab.order_service.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder setFirstname(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder clearFirstname() {
      firstname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder setLastname(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.hab.order_service.event.OrderPlacedEvent.Builder clearLastname() {
      lastname = null;
